...
export function InventoryList({ inventory, onUpdateQuantity, onSetQuantity }: InventoryListProps) {
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Input
                      type="number"
                      className="h-8 w-16 text-center font-bold text-[#5c4b3b] dark:text-[#e7c27d] border-black/10 dark:border-white/10 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                      value={item.quantity}
